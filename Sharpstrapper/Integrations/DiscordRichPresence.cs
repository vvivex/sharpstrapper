...
using Sharpstrapper.Models.RobloxApi;
using DiscordRPC;

namespace Sharpstrapper.Integrations
{
    public class DiscordRichPresence : IDisposable
    {
        ...
        private void ProcessSetRichPresence(Message message, bool implicitUpdate)
        {
            ...
            Models.SharpstrapperRPC.RichPresence? presenceData;
            ...
            try
            {
                presenceData = message.Data.Deserialize<Models.SharpstrapperRPC.RichPresence>();
            }
            catch (Exception)
            {
        ...
        public async Task<bool> SetCurrentGame()
        {
            ...
            string status = _activityWatcher.Data.ServerType switch
            {
                ...
                _ => $"by {universeDetails.Data.Creator.Name}" + (universeDetails.Data.Creator.HasVerifiedBadge ? " â˜‘ï¸" : ""),
            };
            ...
            // this is used for configuration from SharpstrapperRPC
