...
namespace Sharpstrapper
{
    ...
    {
#if QA_BUILD
        public const string ProjectName = "Sharpstrapper-QA";
#else
        public const string ProjectName = "Sharpstrapper";
#endif
        public const string ProjectOwner = "Sharpstrapper";
        public const string ProjectRepository = "Sharpstrapperlabs/Sharpstrapper";
        public const string ProjectDownloadLink = "https://Sharpstrapperlabs.com";
        public const string ProjectHelpLink = "https://Sharpstrapperlabs.com/wiki/help/";
        public const string ProjectSupportLink = "https://github.com/Sharpstrapperlabs/Sharpstrapper/issues/new";
        ...
        public static string WebUrl
        {
            get {
                ...
                string url = ConstructSharpstrapperWebUrl();
        ...
        public static string ConstructSharpstrapperWebUrl()
        {
            ...
            if (Settings.Prop.WebEnvironment == WebEnvironment.Production || !Settings.Prop.DeveloperMode)
                return "services.Sharpstrapperlabs.com";

            string? sub = Settings.Prop.WebEnvironment.GetDescription();
            return $"services-{sub}.Sharpstrapperlabs.com";
        }
