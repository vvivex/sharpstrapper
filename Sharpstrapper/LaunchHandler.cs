...
using Sharpstrapper.UI.Elements.Dialogs;
using Sharpstrapper.Enums;
...
namespace Sharpstrapper
{
    public static class LaunchHandler
    {
        ...
        public static void LaunchInstaller()
        {
            ...
            {
#if QA_BUILD
                Frontend.ShowMessageBox("You are about to install a QA build of Sharpstrapper. The red window border indicates that this is a QA build.\n\nQA builds are handled completely separately of your standard installation, like a virtual environment.", MessageBoxImage.Information);
#endif
        ...
        public static void LaunchBackgroundUpdater()
        {
            ...
            App.Bootstrapper = new Bootstrapper(launchMode)
            {
                MutexNamePrefix = "Sharpstrapper-BackgroundUpdater",
            ...
            Task.Run(() =>
            {
                ...
                using (EventWaitHandle handle = new EventWaitHandle(false, EventResetMode.AutoReset, "Sharpstrapper-BackgroundUpdaterKillEvent"))
                    handle.WaitOne();
