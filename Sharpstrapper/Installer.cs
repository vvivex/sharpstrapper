...
namespace Sharpstrapper
{
    internal class Installer
    {
        ...
        public void DoInstall()
        {
            ...
            // only register player, for the scenario where the user installs Sharpstrapper, closes it,
        ...
        public static void HandleUpgrade()
        {
            ...
            if (existingVer is not null)
            {
                ...
                if (Utilities.CompareVersions(existingVer, "2.8.0") == VersionComparison.LessThan)
                {
                    ...
                    string oldStartPath = Path.Combine(Paths.WindowsStartMenu, "Sharpstrapper");
                    ...
                    Registry.CurrentUser.DeleteSubKeyTree("Software\\Sharpstrapper", false);
