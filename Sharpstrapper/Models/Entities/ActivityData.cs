...
using Sharpstrapper.Models.APIs;
using CommunityToolkit.Mvvm.Input;

namespace Sharpstrapper.Models.Entities
{
    public class ActivityData
    {
        ...
        // everything below here is optional strictly for Sharpstrapperrpc, discord rich presence, or game history
