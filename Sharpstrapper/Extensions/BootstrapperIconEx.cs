...
namespace Sharpstrapper.Extensions
{
    static class BootstrapperIconEx
    {
        public static IReadOnlyCollection<BootstrapperIcon> Selections => new BootstrapperIcon[]
        {
            ...
            BootstrapperIcon.IconSharpstrapperClassic,
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconSharpstrapper;
            }

            return icon switch
            {
                BootstrapperIcon.IconSharpstrapper => Properties.Resources.IconSharpstrapper,
                ...
                BootstrapperIcon.IconSharpstrapperClassic => Properties.Resources.IconSharpstrapperClassic,
                _ => Properties.Resources.IconSharpstrapper
            };
        }
    }
}
