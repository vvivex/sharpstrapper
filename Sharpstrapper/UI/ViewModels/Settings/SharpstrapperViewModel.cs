...
{
    public class SharpstrapperViewModel : NotifyPropertyChangedViewModel
    {
        ...
        private void ExportData()
        {
            ...
            { 
                FileName = $"Sharpstrapper-export-{timestamp}.zip",
        ...
        {
            const string LOG_IDENT = "SharpstrapperViewModel::AddFilesToZipStream";
