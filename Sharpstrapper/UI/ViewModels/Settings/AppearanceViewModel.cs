...
using Sharpstrapper.UI.Elements.Settings;
using Sharpstrapper.UI.Elements.Editor;
using Sharpstrapper.UI.Elements.Dialogs;

namespace Sharpstrapper.UI.ViewModels.Settings
{
            ...
            set
            {
                if (String.IsNullOrEmpty(value))
                {
                    if (App.Settings.Prop.BootstrapperIcon == BootstrapperIcon.IconCustom)
                        App.Settings.Prop.BootstrapperIcon = BootstrapperIcon.IconSharpstrapper;
                }
                else
                {
