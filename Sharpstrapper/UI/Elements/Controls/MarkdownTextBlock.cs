using Sharpstrapper.UI.ViewModels;
...
namespace Sharpstrapper.UI.Elements.Controls
{
    /// <summary>
    ...
    class MarkdownTextBlock : TextBlock
    {
        ...
        private static void OnTextMarkdownChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs dependencyPropertyChangedEventArgs)
        {
            ...
            // https://github.com/Sharpstrapperlabs/Sharpstrapper/blob/289b9dec77cf35b2cc6504019bc9c7701626be1f/Sharpstrapper/UI/Elements/Controls/MarkdownTextBlock.cs#L111
