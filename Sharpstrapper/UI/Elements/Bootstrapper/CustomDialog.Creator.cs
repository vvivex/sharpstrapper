...
namespace Sharpstrapper.UI.Elements.Bootstrapper
{
    public partial class CustomDialog
    {
        ...
        {
            ["SharpstrapperCustomBootstrapper"] = HandleXmlElement_SharpstrapperCustomBootstrapper_Fake,
        ...
        private static void AssertThemeVersion(string? versionStr)
        {
            if (string.IsNullOrEmpty(versionStr))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotSet", "SharpstrapperCustomBootstrapper");

            if (!uint.TryParse(versionStr, out uint version))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotNumber", "SharpstrapperCustomBootstrapper");
            ...
            switch (version)
            {
                ...
                case 0: // Themes made between Oct 19, 2024 to Mar 11, 2025 (on the feature/custom-bootstrappers branch)
                    throw new CustomThemeException("CustomTheme.Errors.VersionNotSupported", "SharpstrapperCustomBootstrapper", version);
                default:
                    throw new CustomThemeException("CustomTheme.Errors.VersionNotRecognised", "SharpstrapperCustomBootstrapper", version);
            }
        }
        ...
        private void HandleXmlBase(XElement xml)
        {
            ...
            if (xml.Name != "SharpstrapperCustomBootstrapper")
                throw new CustomThemeException("CustomTheme.Errors.InvalidRoot", "SharpstrapperCustomBootstrapper");
            ...
            // handle root
            HandleXmlElement_SharpstrapperCustomBootstrapper(this, xml);
