...
using Sharpstrapper.UI.ViewModels.Bootstrapper;
...
namespace Sharpstrapper.UI.Elements.Bootstrapper
{
    ...
    public partial class ByfronDialog : IBootstrapperDialog
    {
        ...
        public Sharpstrapper.Bootstrapper? Bootstrapper { get; set; }
        ...
        public ByfronDialog()
        {
            ...
            if (App.Settings.Prop.Theme.GetFinal() == Theme.Light)
            {
                ...
                // Use the new packaged Sharpstrapper logo for light theme as well
                _viewModel.ByfronLogoLocation = new BitmapImage(new Uri("pack://application:,,,/SharpstrapperLogo.png"));
            }
