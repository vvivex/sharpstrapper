...
using Sharpstrapper.AppData;
using Sharpstrapper.RobloxInterfaces;
using Sharpstrapper.UI.Elements.Bootstrapper.Base;

using ICSharpCode.SharpZipLib.Zip;

namespace Sharpstrapper
{
    public class Bootstrapper
    {
        ...
        public string BackgroundUpdaterMutexName => $"Sharpstrapper-BackgroundUpdater-{_launchMode}";

        public string MutexNamePrefix { get; set; } = "Sharpstrapper-Bootstrapper";
        ...
        private async Task<bool> CheckForUpdates()
        {
            ...
            {
                App.Logger.WriteLine(LOG_IDENT, $"More than one Sharpstrapper instance running, aborting update check");
                return false;
            }
            ...
            SetStatus(Strings.Bootstrapper_Status_UpgradingSharpstrapper);

            try
            {
#if DEBUG_UPDATER
                string downloadLocation = Path.Combine(Paths.TempUpdates, "Sharpstrapper.exe");
                ...
                catch (Exception ex)
                {
                    ...
                    if (ex.GetType() == typeof(ChecksumFailedException))
                    {
                        ...
                        Frontend.ShowConnectivityDialog(
                            ...
                            String.Format(Strings.Dialog_Connectivity_UnableToDownloadReason, "[https://Sharpstrapperlabs.com/wiki/help/Sharpstrapper-cannot-download-roblox/](https://Sharpstrapperlabs.com/wiki/help/Sharpstrapper-cannot-download-roblox/)"),
